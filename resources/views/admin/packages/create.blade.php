...
<div class="mb-10">
    ...
    <h2 class="text-3xl font-bold tracking-tight text-slate-800">Tambah <span class="gradient-text">Paket Laundry</span></h2>
    <p class="text-slate-500 mt-1">Buat jenis layanan atau paket laundry baru.</p>
</div>
        ...
        <form action="{{ route('packages.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" 
                       ...
                       placeholder="Masukkan nama paket (misal: Cuci Setrika Ekspres)" required>
            </div>
